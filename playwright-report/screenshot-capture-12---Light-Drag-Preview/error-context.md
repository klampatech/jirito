...
- Name: screenshot-capture.spec.mjs >> 12 - Light Drag Preview
- Location: tests/screenshot-capture.spec.mjs:220:1
...
```
Error: locator.hover: Test timeout of 15000ms exceeded.
Call log:
